  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-4xl mx-auto px-6 py-24">
        <h1 className="text-4xl md:text-5xl font-bold text-[#111111] mb-8">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-[#666666]">
          <section>
            ...
            <p>
              SiteMaxi ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">2. Information We Collect</h2>
            <h3 className="text-xl font-semibold text-[#111111] mb-3 mt-4">Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-[#111111] mb-3 mt-4">Automatically Collected Information</h3>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">4. Information Sharing and Disclosure</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">6. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">7. Your Rights and Choices</h2>
            ...
            <p className="mt-3">To exercise these rights, please contact us at hello@sitemaxi.com</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">8. Cookies and Tracking Technologies</h2>
            <p className="mb-3">
              We use cookies and similar tracking technologies to track activity on our website and hold certain information. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. For more information, please see our <a href="/cookie-policy" className="text-[#8B5CF6] hover:underline">Cookie Policy</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">9. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">10. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">11. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">12. Changes to This Privacy Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#111111] mb-4">13. Contact Us</h2>
