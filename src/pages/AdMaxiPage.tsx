...
function HeroSection() {
  return (
    <section className="py-24 px-4 md:px-12 text-center max-w-4xl mx-auto" style={{ paddingTop: '7rem' }}>
      ...
      >
        Most social ad budgets are burned on poor targeting, untested creatives, and zero conversion tracking. We build Meta, Pinterest and Tiktok campaigns that are engineered from day one to drive real leads at a profitable cost.
      </p>
...
function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Ad spend is the budget you pay directly to Meta, or other social platfrom for showing your ads. It is separate from our management fee. We recommend a minimum ad spend of $500–$1,000/month(depending on the industry) to get meaningful data and results."
    },
    {
